...
**무료 한도가 아주 좁습니다 — 하루 10개 문장입니다.** (`gemini-3.1-flash-tts`, 2026-08-13 실측.
기다려도 안 풀리는 하루 한도입니다.) 한 번의 피드백에 쉐도잉 2~3줄 + 표현 3개가 나오니 두 판이면
넘습니다. 그래서 1순위가 막히면 **`gemini-2.5-flash-preview-tts`로 자동으로 넘어갑니다** —
모델마다 한도가 따로라 그만큼 더 씁니다. 둘 다 막히면 기기 음성으로 내려가고, **그때는 쉐도잉
카드에 그렇게 적힙니다.** 한 번 들어본 문장은 저장돼 있으니 다음 날도 좋은 목소리로 나옵니다.
